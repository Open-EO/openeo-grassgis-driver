...
def create_process_description():
    p_data = Parameter(description="The first summand.",
                       schema={
                               "type": [
                                 "number",
                                 "null"
    ...
    p_data2 = Parameter(description="The second summand.",
                        schema={
                                "type": [
                                  "number",
                                  "null"
    ...
    rv = ReturnValue(description="The computed sum of the two numbers.",
                     schema={
                             "type": [
                               "number",
                               "null"
