...
def create_process_description():
    ...
    rv = ReturnValue(description="Returns `true` if `x` is equal to `y`, `null` if any operand is `null`, otherwise `false`.",
                     schema={
                             "type": [
                               "boolean",
                               "null"
    ...
    graph = ProcessGraph(title="title", description="description", process_graph={"eq_1": node})
