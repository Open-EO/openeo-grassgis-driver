...
def create_process_description():
    ...
    rv = ReturnValue(description="`true` if the data is a no-data value, otherwise `false`",
                     schema={
                             "type": "boolean"
                     })
    ...
    graph = ProcessGraph(title="title", description="description", process_graph={"isnodata_1": node})
