...
def create_process_description():
    ...
    rv = ReturnValue(description="The computed value for `base` raised to the power of `p`.",
                     schema={
                             "type": [
                               "number",
                               "null"
    ...
    graph = ProcessGraph(title="title", description="description", process_graph={"power_1": node})
