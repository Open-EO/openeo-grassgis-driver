...
def create_process_description():
    ...
    rv = ReturnValue(description="The computed product of the sequence of numbers.",
                     schema={
                             "type": [
                               "number",
                               "null"
    ...
    graph = ProcessGraph(title="title", description="description", process_graph={"product_1": node})
